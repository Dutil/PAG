...
def build_sampler(tparams, options, trng, use_noise):
    ...
    init_sample = tensor.matrix('init_sample', dtype='float32')
    init_action_plan = tensor.tensor3('init_action_plan')
    ...
    [next_state_char, next_state_word, next_bound_char, next_bound_word, next_ctx, next_alpha, probs, next_sample,
    ...
    outs = [next_probs, next_sample, next_state_char, next_state_word, next_bound_char, next_bound_word, next_sample, next_action_plan]
